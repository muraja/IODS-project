...
```{r}
#could come up with this but I don't know how to set a cut-off point
library(tidyverse)
gapdata2007 %>% 
  filter(continent == "Europe") %>%  # how was I supposed to know this?
  ggplot(aes(x = fct_reorder(country, lifeExp), y  = lifeExp)) +
  geom_bar(stat = "identity", colour = "deepskyblue", fill = NA) +
